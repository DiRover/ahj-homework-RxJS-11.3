...
export default class Store {
  constructor(data) {
    ...
    this.data = data.projects;// записваем общий список проектов и задач
    this.currerntProject = data.projects[0];// начальный, по умолчанию, проект
    this.state$.next({ projects: this.data, currerntProject: this.currerntProject });// эмитим (или задаём хз как там) первоначальный стейт
  }
